...
public class AACFileReader extends Thread {
    ...
    public AACFileReader(String path) {
                        ...
                        if (frameLen + readLen < FRAME_MAX_LEN) {
                            ...
                            while (headFirstIndex >= 0 && isHead(frame, headFirstIndex)) {
                                ...
                                if (headSecondIndex > 0 && isHead(frame, headSecondIndex)) {
                                    ...
                                    audioUtil.decode$Play(frame, headFirstIndex, headSecondIndex - headFirstIndex);
